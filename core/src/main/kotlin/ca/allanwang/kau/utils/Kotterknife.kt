...
fun <V : View> SupportFragment.bindView(id: Int): ReadOnlyProperty<SupportFragment, V> =
  required(id, viewFinder)

fun <V : View> RecyclerView.ViewHolder.bindView(
  id: Int
...
fun <V : View> RecyclerView.ViewHolder.bindOptionalView(
  id: Int
...
fun <V : View> DialogFragment.bindViews(
  vararg ids: Int
): ReadOnlyProperty<DialogFragment, List<V>> = required(ids, viewFinder)

fun <V : View> SupportDialogFragment.bindViews(
  vararg ids: Int
...
fun <V : View> SupportFragment.bindViews(
  vararg ids: Int
...
fun <V : View> DialogFragment.bindOptionalViews(
  vararg ids: Int
): ReadOnlyProperty<DialogFragment, List<V>> = optional(ids, viewFinder)

fun <V : View> SupportDialogFragment.bindOptionalViews(
  vararg ids: Int
...
fun <V : View> SupportFragment.bindOptionalViews(
  vararg ids: Int
): ReadOnlyProperty<SupportFragment, List<V>> = optional(ids, viewFinder)

fun <V : View> ViewHolder.bindOptionalViews(
  vararg ids: Int
...
private open class Lazy<in T, out V>(private val initializer: (T, KProperty<*>) -> V) :
...
fun <V : View> View.bindViewResettable(id: Int): ReadOnlyProperty<View, V> =
  requiredResettable(id, viewFinder)

fun <V : View> Activity.bindViewResettable(id: Int): ReadOnlyProperty<Activity, V> =
  requiredResettable(id, viewFinder)

fun <V : View> Dialog.bindViewResettable(id: Int): ReadOnlyProperty<Dialog, V> =
  requiredResettable(id, viewFinder)

fun <V : View> DialogFragment.bindViewResettable(id: Int): ReadOnlyProperty<DialogFragment, V> =
  requiredResettable(id, viewFinder)

fun <V : View> SupportDialogFragment.bindViewResettable(
  id: Int
): ReadOnlyProperty<SupportDialogFragment, V> = requiredResettable(id, viewFinder)

fun <V : View> Fragment.bindViewResettable(id: Int): ReadOnlyProperty<Fragment, V> =
  requiredResettable(id, viewFinder)

fun <V : View> SupportFragment.bindViewResettable(id: Int): ReadOnlyProperty<SupportFragment, V> =
  requiredResettable(id, viewFinder)

fun <V : View> ViewHolder.bindViewResettable(id: Int): ReadOnlyProperty<ViewHolder, V> =
  requiredResettable(id, viewFinder)

fun <V : View> View.bindOptionalViewResettable(id: Int): ReadOnlyProperty<View, V?> =
  optionalResettable(id, viewFinder)

fun <V : View> Activity.bindOptionalViewResettable(id: Int): ReadOnlyProperty<Activity, V?> =
  optionalResettable(id, viewFinder)

fun <V : View> Dialog.bindOptionalViewResettable(id: Int): ReadOnlyProperty<Dialog, V?> =
  optionalResettable(id, viewFinder)

fun <V : View> DialogFragment.bindOptionalViewResettable(
  id: Int
): ReadOnlyProperty<DialogFragment, V?> = optionalResettable(id, viewFinder)

fun <V : View> SupportDialogFragment.bindOptionalViewResettable(
  id: Int
): ReadOnlyProperty<SupportDialogFragment, V?> = optionalResettable(id, viewFinder)

fun <V : View> Fragment.bindOptionalViewResettable(id: Int): ReadOnlyProperty<Fragment, V?> =
  optionalResettable(id, viewFinder)

fun <V : View> SupportFragment.bindOptionalViewResettable(
  id: Int
): ReadOnlyProperty<SupportFragment, V?> = optionalResettable(id, viewFinder)

fun <V : View> ViewHolder.bindOptionalViewResettable(id: Int): ReadOnlyProperty<ViewHolder, V?> =
  optionalResettable(id, viewFinder)

fun <V : View> View.bindViewsResettable(vararg ids: Int): ReadOnlyProperty<View, List<V>> =
  requiredResettable(ids, viewFinder)

fun <V : View> Activity.bindViewsResettable(vararg ids: Int): ReadOnlyProperty<Activity, List<V>> =
  requiredResettable(ids, viewFinder)

fun <V : View> Dialog.bindViewsResettable(vararg ids: Int): ReadOnlyProperty<Dialog, List<V>> =
  requiredResettable(ids, viewFinder)

fun <V : View> DialogFragment.bindViewsResettable(
  vararg ids: Int
): ReadOnlyProperty<DialogFragment, List<V>> = requiredResettable(ids, viewFinder)

fun <V : View> SupportDialogFragment.bindViewsResettable(
  vararg ids: Int
): ReadOnlyProperty<SupportDialogFragment, List<V>> = requiredResettable(ids, viewFinder)

fun <V : View> Fragment.bindViewsResettable(vararg ids: Int): ReadOnlyProperty<Fragment, List<V>> =
  requiredResettable(ids, viewFinder)

fun <V : View> SupportFragment.bindViewsResettable(
  vararg ids: Int
): ReadOnlyProperty<SupportFragment, List<V>> = requiredResettable(ids, viewFinder)

fun <V : View> ViewHolder.bindViewsResettable(
  vararg ids: Int
): ReadOnlyProperty<ViewHolder, List<V>> = requiredResettable(ids, viewFinder)

fun <V : View> View.bindOptionalViewsResettable(vararg ids: Int): ReadOnlyProperty<View, List<V>> =
  optionalResettable(ids, viewFinder)

fun <V : View> Activity.bindOptionalViewsResettable(
  vararg ids: Int
): ReadOnlyProperty<Activity, List<V>> = optionalResettable(ids, viewFinder)

fun <V : View> Dialog.bindOptionalViewsResettable(
  vararg ids: Int
): ReadOnlyProperty<Dialog, List<V>> = optionalResettable(ids, viewFinder)

fun <V : View> DialogFragment.bindOptionalViewsResettable(
  vararg ids: Int
): ReadOnlyProperty<DialogFragment, List<V>> = optionalResettable(ids, viewFinder)

fun <V : View> SupportDialogFragment.bindOptionalViewsResettable(
  vararg ids: Int
): ReadOnlyProperty<SupportDialogFragment, List<V>> = optionalResettable(ids, viewFinder)

fun <V : View> Fragment.bindOptionalViewsResettable(
  vararg ids: Int
): ReadOnlyProperty<Fragment, List<V>> = optionalResettable(ids, viewFinder)

fun <V : View> SupportFragment.bindOptionalViewsResettable(
  vararg ids: Int
): ReadOnlyProperty<SupportFragment, List<V>> = optionalResettable(ids, viewFinder)

fun <V : View> ViewHolder.bindOptionalViewsResettable(
  vararg ids: Int
...
private class LazyResettable<in T, out V>(initializer: (T, KProperty<*>) -> V) :
  Lazy<T, V>(initializer) {
  override fun getValue(thisRef: T, property: KProperty<*>): V {
