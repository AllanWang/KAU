 ...
 *
 * Canvas drawn ripples that keep the previous color Extends to view dimensions Supports multiple
 * ripples from varying locations
 */
class RippleCanvas
@JvmOverloads
constructor(context: Context, attrs: AttributeSet? = null, defStyleAttr: Int = 0) :
  ...
  /**
   * Draw ripples one at a time in the order given To support transparent ripples, we simply erase
   * the overlapping base before adding a new circle
   */
