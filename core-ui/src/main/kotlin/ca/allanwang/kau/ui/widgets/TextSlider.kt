 ...
 *
 * Text switcher with global text color and embedded sliding animations Also has a stack to keep
...
class TextSlider @JvmOverloads constructor(context: Context, attrs: AttributeSet? = null) :
  ...
  /**
   * Sets the text as the previous title No further checks are done, so be sure to verify with
   * [isRoot]
   */
