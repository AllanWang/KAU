...
/**
 * Dynamic camera items for both images and videos Given that images require a uri to save the file,
 * they must be implemented on top of this abstract class.
 *
...
class MediaActionCameraVideo(override var color: Int = MediaPickerCore.accentColor) : MediaAction {
