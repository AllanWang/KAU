 ...
 *
 * Extension functions for interacting with the image picker as well as internal constants
 */
...
/**
 * Image picker result call under [Activity.onActivityResult] and make sure that the requestCode
 * matches first
 */
...
internal fun <T> RequestBuilder<T>.applyMediaOptions(context: Context) =
  apply(
    RequestOptions()
      ...
      .centerCrop()
      .override(MediaPickerCore.viewSize(context))
  )
