...
abstract class KPrefItemBase<T>(protected val base: BaseContract<T>) : KPrefItemCore(base) {
  ...
  /**
   * Extension of the core contract Since everything that extends the base is an actual preference,
   * there must be a getter and setter The rest are optional and will have their defaults
   */
